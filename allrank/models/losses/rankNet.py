...
def rankNet(y_pred, y_true, model_input=None, model=None, padded_value_indicator=PADDED_Y_VALUE, weight_by_diff=False, weight_by_diff_powed=False, indices=None):
    """
